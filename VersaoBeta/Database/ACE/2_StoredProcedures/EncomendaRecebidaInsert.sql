...
-- =============================================
CREATE PROCEDURE EncomendaRecebidaInsert
...
BEGIN
	...
	INSERT INTO EncomendaRecebida (ID_Encomenda,Referencia_Produto,DataEncomenda,QuantidadeEncomenda,Estado,ID_UnidadeFuncional) 

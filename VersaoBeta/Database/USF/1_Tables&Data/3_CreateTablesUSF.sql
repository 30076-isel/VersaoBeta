...
(
	...
	CONSTRAINT fk_RefFuncionario	FOREIGN KEY (ID_Funcionario) REFERENCES Funcionario(ID_Funcionario),
	CONSTRAINT fk_RefPerfil	FOREIGN KEY (ID_Perfil) REFERENCES Perfil(ID_Perfil)
);
...
(
	...
	Data_Picking	DATE,
	ID_Funcionario VARCHAR(50),
	CONSTRAINT fk_PickingFuncionario FOREIGN KEY (ID_Funcionario) REFERENCES Funcionario(ID_Funcionario)
);
...
(
	...
	CONSTRAINT fk_Produto FOREIGN KEY (Referencia_Produto) REFERENCES Produto(Referencia),
	CONSTRAINT fk_Picking FOREIGN KEY (ID_Picking) REFERENCES Picking(ID_Picking)
);
...
(
	...
	Estado					VARCHAR(10),
	ID_Funcionario			VARCHAR(50),
	CONSTRAINT fk_EncomendaProduto FOREIGN KEY (Referencia_Produto) REFERENCES Produto(Referencia),
	CONSTRAINT fk_EncomendaFuncionario	FOREIGN KEY (ID_Funcionario) REFERENCES Funcionario(ID_Funcionario),
...
(
	...
	Referencia_Produto INT,
	CONSTRAINT fk_LoteProduto FOREIGN KEY (Referencia_Produto) REFERENCES Produto(Referencia)
);
